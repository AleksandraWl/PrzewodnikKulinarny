                            ...
                            user.sendEmailVerification()
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()) {
                                                Toast.makeText(Rejestracja.this, "Verification e-mail sent", Toast.LENGTH_SHORT).show();
                                            }
                                            else {
                                                Toast.makeText(Rejestracja.this, "Verification e-mail could not be sent", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
